                        ...
                        <div class="header-actions">
                            ...
                            <div class="header-bottom-set dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
									@if (Route::has('login'))
									@auth
										<li><a class="dropdown-item" href="{{ url('/home') }}">Главная</a></li>
										<li><a class="dropdown-item" href="/admin_panel">Админ Панель</a></li>
										<li><a class="dropdown-item" href="{{ route('logout') }}">Выйти</a></li>
									@else
										<li><a class="dropdown-item" href="{{ route('login') }}">Войти</a></li>
									@if (Route::has('register'))
										<li><a class="dropdown-item" href="{{ route('register') }}">Зарегестрироваться</a></li>
									@endif
									@endauth
									@endif
                                </ul>
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center">
                        <div class="main-menu manu-color-white">
                            <ul>
                                <li class="dropdown"><a href="/">Гланая</a>
                                </li>
                                <li><a href="about.html">О Сайте</a></li>
                                <li class="dropdown position-static"><a href="#">Каталог <i
                                            class="ion-ios-arrow-down"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="/Cat/ldsp">ЛДСП</a></li>
                                                <li><a href="/Cat/mdf">МДФ</a></li>
                                                <li><a href="/Cat/pvh">ПВХ</a></li>
                                                <li><a href="/Cat/stol">Столешницы</a></li>
                                                <li><a href="/Cat/fartuc">Фартуки</a></li>
                                                <li><a href="/Cat/furniture">Фурнитуры</a></li>
                                            </ul>
                                </li>
                                <li class="dropdown"><a href="#">Производители <i class="ion-ios-arrow-down"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="">SwissKrono</a></li>
                                        <li><a href="">Lamtech</a></li>
                                        <li><a href="">KronoSpan</a></li>
                                        <li><a href="">BySpan</a></li>
                                        <li><a href="">Шексна</a></li>
                                        <li><a href="">Скиф</a></li>
                                                                ...
                                                                <div class="body customScroll">
                                                                    <ul class="minicart-product-list">
                                                                        <li>
                                                                            ...
                                                                            <div class="content">
                                                                                <a href="single-product.html" class="title">123</a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <div class="content">
                                                                                <a href="single-product.html" class="title">321</a>
            ...
            <div class="row">
                <div class="col-md-12" data-aos="fade-up">
                    <div class="section-title text-center mb-11">
                        ...
                        <p class="sub-title">Новости Компании
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper-wrapper">
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{$news['image']}}" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">{{$news['created_at']}}</a>
                            </div>
                            <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.html">{{$news['title']}}</a></h5>
                            <p class="blog-detail-text">{{$news['annons']}}</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                            <div class="single-wedge">
                                ...
                                <p class="about-text">Онлайн Каталог НАших Товаров
                                </p>
                ...
                <div class="container">
                    <div class="row flex-sm-row-reverse">
                        ...
                        <div class="col-md-6 text-left">
                            <p class="copy-text">Design and Develop by Amanel</p>
                        </div>
                    </div>
                </div>
            </div>
