                        ...
                        <div class="main-menu manu-color-white">
                            <ul>
                                ...
                                <li class="dropdown"><a href="#">Производители <i class="ion-ios-arrow-down"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="privacy-policy.html">SwissKrono</a></li>
                                        <li><a href="faq.html">Lamtech</a></li>
                                        <li><a href="coming-soon.html">KronoSpan</a></li>
                                        <li><a href="coming-soon.html">BySpan</a></li>
                                        <li><a href="404.html">Шексна</a></li>
                                        <li><a href="coming-soon.html">Скиф</a></li>
                                        <li><a href="coming-soon.html">Китай</a></li>
                                    </ul>
                                </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="product">
                    ...
                    <div class="content">
                        <h5 class="title"><a href="products/{{$furniture['id']}}">{{$furniture['title']}}</a></h5>
                        <span class="price">
